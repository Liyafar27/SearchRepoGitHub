    ...
    private void setResultListView(){
        ...
        for (int i=0 ; i<items.length();i++){
            ...
            try {
                ...
                String owner=jo.getString("full_name");
                String[] parts = owner.split("/");
                String ownerPart= parts[0];
               ...
               String created_at = jo.getString("created_at");
                ...
                adapterList.add(String.valueOf(page*5+i+1)+". Repo Name: "+ repoPart+"\n"
                                +"   Owner: "+ownerPart+"\n"
                                +"   Updated At: "+createdPart+"\n"
...
//                        +"  \uD83D\uDC41  Watch Count: "+jo.getString("watchers_count")+"\n"
                        ...
                        +"  ⭐     Stargazers count: "+jo.getString("stargazers_count")+"\n"
